...
int main(void) {
  ...
  Velocity *v1 = storage_emplace_component(storage, velocities, id1);
  v1->vx = 4;
  v1->vy = 4;

  Position *p0 = storage_emplace_component(storage, positions, id0);
  p0->x = 0;
  p0->y = 0;

  Position *p1 = storage_emplace_component(storage, positions, id1);
  p1->x = 64;
  p1->y = 64;
